...
#include "ui_tabraspberryconfiguration.h"
...
TabRaspberryConfiguration::~TabRaspberryConfiguration()
{
    delete ui;
}

TabRaspberryConfiguration::FormState TabRaspberryConfiguration::getConfigRaspState() const
{
    return configRaspState;
}

void TabRaspberryConfiguration::setStateRaspConfig(const TabRaspberryConfiguration::FormState &value)
{
...
void TabRaspberryConfiguration::clearFields()
{
    ui->leFile->setText("");
    ui->leDataID->setText("");
    ui->leDataIP->setText("");
...
void TabRaspberryConfiguration::btCreateNewFileClicked()
{
...
void TabRaspberryConfiguration::btDiscardClicked()
{
    setStateRaspConfig(KEmpty);
}

void TabRaspberryConfiguration::btSaveClicked()
{
...
void TabRaspberryConfiguration::btEditClicked()
{

}

void TabRaspberryConfiguration::btOpenExistingFileClicked()
{
...
void TabRaspberryConfiguration::btCloneFileClicked()
{
